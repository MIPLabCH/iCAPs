...
subj_thres_paths=fullfile(subj_paths,'TA_results','exampleToolbox','Thresholding',thresh_title);
subj_TA_paths=fullfile(subj_paths,'TA_results','exampleToolbox','TotalActivation');
subj_input_paths=fullfile(subj_paths,'TA_results','exampleToolbox','inputData');

out_thres=fullfile(subj_paths,'TA_results','exampleToolbox_MNI','Thresholding',thresh_title);
out_TA=fullfile(subj_paths,'TA_results','exampleToolbox_MNI','TotalActivation');
